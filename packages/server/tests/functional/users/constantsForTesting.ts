import { authApiEndPoints, userApiEndPoints, userProfilesApiEndpoints } from 'App/Routes'
...
// Auth
export const AUTH_LOGIN_PATH = `${API_PATH}${authApiEndPoints.login}`
export const AUTH_LOGOUT_PATH = `${API_PATH}${authApiEndPoints.logout}`
